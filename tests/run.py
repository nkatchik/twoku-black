...
suites = {
    ...
    'channelpage': functions('ChannelPage.brs', ['onGetVideos','channelHasVideos','focusContent','cancelPlaybackRequest','onGetVideoUrl','channelVisible','channelFollowerLabel']),
